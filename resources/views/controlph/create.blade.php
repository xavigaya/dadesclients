    ...
    <div class ="container col-md-8 col-md-offset-2">
        <div class ="well well bs-component">
            <form class ="form-horizontal" method="post">
                ...
                <fieldset>
                    <legend><h2 class="bg-warning">Afegir una medició de Ph</h2></legend>
                    ...
                    <!--
                    <div class ="form-group">
                        <h3 class ="bg-warning col-lg-12">Nevera 3</h3>
                    </div>
                    <div class ="form-group">
                        <div class ="col-lg-2">
                            <label for ="ph3" class ="control-label">Ph</label>
                        </div>
                        <div class ="col-lg-2">
                            <input id="ph3" type="text" placeholder="0.00" name="ph3" size="4"/>
                        </div>
                        <div class ="col-lg-2">
                            <label for ="cond3" class ="control-label">Conductivitat</label>
                        </div>
                        <div class ="col-lg-2">
                            <input id="cond3" type="text" placeholder="0000" name="cond3" size="4"/>
                        </div>
                        <div class ="col-lg-2">
                            <label for ="temp3" class ="control-label">Temperatura</label>
                        </div>
                        <div class ="col-lg-2">
                            <input id="temp3" type="text" placeholder="0000" name="temp3" size="4"/>
                        </div>
                    </div>
                    -->
