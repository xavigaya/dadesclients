@extends('master')
@section('title', 'Afegir Dades Tècniques')
@section('content')
    <div class ="container col-md-8 col-md-offset-2">
        <div class ="well well bs-component">
            <form class ="form-horizontal" method="post">
                ...
                <fieldset>
                    <legend>Afegir dades tècniques</legend>
                    ...
                    <div class ="form-group">
                        ...
                        <div class ="col-lg-10">
                            <input type="text" class ="form-control" id ="plantilla" placeholder="Plantilla" name="plantilla">
                        </div>
                    </div>
                    <div class ="form-group">
                        <label for ="observacions" class ="col-lg-2 control-label">Observacions</label>
                        <div class ="col-lg-10">
                            <textarea type="text" class ="form-control" id ="observacions" placeholder="Dades d'interés, excepcions, ..." name="observacions"></textarea>
                        </div>
                    </div>
                    <div class ="form-group">
